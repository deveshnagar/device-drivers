...
static int __init myInit(void)
{
	...
	{
		/*
		 * These files wil be created :
		 * /sys/devices/virtual/char/final_simple1
		 * /sys/class/char/final_simple1
		 * /dev/final_simple
		 *
		 * **This file get created when we insmod this module.
		 * Even if we are not doing device_create() / alloc_chrdev_region(), this file will be created :
		 * /sys/module/final_simple_rough
		 *
		 */
	}
#endif
