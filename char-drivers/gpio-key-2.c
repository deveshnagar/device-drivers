...
#define GPIO_NUMBER 9		//gpio 9 we can use, create a switch circuit
							//gpio number 4 is input key on radxa (big button)
...
#if 1
/*
 * Yesss. In this version it is working. Using gpio 9.
 */
	...
	ret = gpio_request(GPIO_NUMBER, "GPIO_9");
	if(ret < 0)
	{
